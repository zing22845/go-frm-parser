...
class Charset(collections.namedtuple(
        'Charset',
...
# iterate over the Charsets and print each line in the format:
# 32: {32, "armscii8", "armscii8_general_ci", true, 1},
# let charset.is_default lowercase
for charset in CHARSETS.values():
    print(f'{charset.id}: {{{charset.id}, "{charset.name}", "{charset.collation}", {str(charset.is_default).lower()}, {charset.maxlen}}},')